 ...
 * @author lucy
 */
public class CapNhatCD extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapNhatCD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
