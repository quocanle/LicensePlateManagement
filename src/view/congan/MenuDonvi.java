...
public class MenuDonvi extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        searchComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã đơn vị", "Tên đơn vị" }));
    ...
    private ArrayList<DonVi> searchMode() {
        ArrayList<DonVi> listDonVi = controller.getAllDonVi();
        ArrayList<DonVi> donViSearched = new ArrayList<>();
